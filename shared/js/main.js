...
(function ($) {
	...
	// 07. Data CSS Js
	if(isMobile){
		$("[data-background-sm").each(function () {
			$(this).css("background-image", "url( " + $(this).attr("data-background-sm") + "  )");
		});
	}else{
	...
	if (jQuery("#slider-range").length > 0) {
		$("#slider-range").slider({
			...
			slide: function (event, ui) {
				$("#amount").val(ui.values[0] + "dhs To " + ui.values[1] + "dhs" );
			}
		});
		$("#amount").val($("#slider-range").slider("values", 0) + 
			"dhs To " + $("#slider-range").slider("values", 1) + "dhs");
	}

	if (jQuery("#slider-range-mobile").length > 0) {
		$("#slider-range-mobile").slider({
			...
			values: [50, 3000],
			slide: function (event, ui) {
				$("#amount-mobile").val(ui.values[0] + "dhs To " + ui.values[1] + "dhs" );
			}
		});
		$("#amount-mobile").val($("#slider-range-mobile").slider("values", 0) + 
			"dhs To " + $("#slider-range-mobile").slider("values", 1) + "dhs");
	}
